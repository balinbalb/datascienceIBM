...
def get_scatter_chart(entered_site, entered_payload):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df = filtered_df[filtered_df['Launch Site'] == entered_site]
        filtered_df=filtered_df.groupby('class').size()['Payload Mass (kg)'].mean().reset_index() 
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', 
        y='class', 
        color="Booster Version Category")
        return fig
# print(spacex_df.groupby('class').size())
# print((spacex_df.groupby('class').size()).reset_index(name='B'))
# Run the app
